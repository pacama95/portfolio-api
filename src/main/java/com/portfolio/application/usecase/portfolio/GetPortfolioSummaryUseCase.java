...
public class GetPortfolioSummaryUseCase {
    ...
    private PortfolioSummary calculateSummary(List<CurrentPosition> positions) {
        ...
        for (CurrentPosition position : positions) {
            ...
            BigDecimal marketValue = position.getTotalMarketValue() != null ? position.getTotalMarketValue() : BigDecimal.ZERO;
            BigDecimal positionCost = position.getTotalInvestedAmount() != null ? position.getTotalInvestedAmount() : BigDecimal.ZERO;

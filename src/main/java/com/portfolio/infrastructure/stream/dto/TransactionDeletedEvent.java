...
/**
 * Transaction deleted event payload with full transaction details for rollback
 * Contains the same information as TransactionCreatedEvent to enable transaction reversal
 */
